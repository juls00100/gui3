...
public class viewEvals extends javax.swing.JFrame {
    ...
    public viewEvals() {
        ...
        conf.logEvent("Viewed his/her evaluation results"); 
        conf.designTable(jTable1); 
        setupDashboard();
    ...
    public void displayMyEvals() {
        // Note: s_u_id is the Student's ID in your tbl_evaluation
        String sql = "SELECT e.e_id AS 'EVALUATION ID', u.u_name AS 'TEACHER', e.e_date AS 'DATE' "
        ...
        try (java.sql.Connection conn = java.sql.DriverManager.getConnection("jdbc:sqlite:aes.db");
            ...
            pst.setString(1, config.getID()); // Gets ID from session
    ...
    private void initComponents() {
        ...
        user1.setText("STUDENT EVALUATIONS");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, 550, 220));
        ...
        jPanel1.add(SAVE, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 350, 250, 40));
    ...
    private void printMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_printMouseClicked
        config conf = new config();
        conf.exportToPDF(jTable1, "Evaluation_Report");
