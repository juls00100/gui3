...
public class seditUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(totp4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 70, 50));
    ...
    if (u_pass.isEmpty()) {String sql = "UPDATE tbl_user SET u_name = ?, u_email = ?, u_image = ? WHERE u_id = ?";
        result = conf.updateRecord(sql, u_name, u_email, destination, u_id);
    } else {
        // SQL nga NAAY labot ang hashed password ug image
    ...
    conf.logEvent("Updated his/her profile information");    
